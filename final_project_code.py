...
num_pills2 = filter_data['DOSAGE_UNIT']
...
delaware_data2 = delaware_data.copy()
delaware_data2 = delaware_data2.set_index('manufacturer')
delaware_data2 = delaware_data2.apply(pd.to_numeric, errors = 'coerce')
